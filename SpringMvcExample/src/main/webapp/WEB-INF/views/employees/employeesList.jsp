...
<body>
	<div id="main">
		...
		<div data-role="header" data-theme="b" role="banner"
			...
			<h1 class="ui-title" role="heading" aria-level="1">Employees
				List</h1>
					...
					<div data-role="navbar" data-iconpos="left" class="ui-navbar"
						...
						<ul class="ui-grid-b">
							...
							<li class="ui-block-c"><a
								...
								data-icon="gear"
								class="ui-btn-active ui-link ui-btn ui-icon-gear ui-btn-icon-left">Employees</a></li>
						</ul>
					</div>
					<!-- /navbar -->
				</div>
					...
					<td>
						...
						<div data-role="controlgroup" data-type="horizontal"
							...
							<div class="ui-controlgroup-controls ">
								...
								<a
									href="${pageContext.request.contextPath}/employee/editEmployee?id=${employee.id}"
									class="ui-btn ui-corner-all ui-icon-edit ui-btn-icon-left">Edit</a>
								<a
									href="${pageContext.request.contextPath}/employee/deleteEmployee?id=${employee.id}"
		...
		<a data-role="button"
			href="${pageContext.request.contextPath}/employee/addEmployee">Add
			New Employee</a>
